...
public class ProductResource {
	...
	@ApiOperation(value="Returns the product Entity by ID")
	...
	produces=MediaType.APPLICATION_JSON_VALUE, value="/addproduct")
	@ApiOperation(value="Add the product Entity")
